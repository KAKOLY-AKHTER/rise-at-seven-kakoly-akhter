                    ...
                    <div className="hero-content__top">
                        <div className="hero-content__tagline-wrap">
                            ...
                            <div className="hero-content__awards-row">
                                ...
                                <img src="/images/awards/global-search.png" className="hero-content__award-logo" alt="Global Search Awards" />
                                <img src="/images/awards/the-drum.png" className="hero-content__award-logo" alt="The Drum" />
                                <img src="/images/awards/uk-social.png" className="hero-content__award-logo" alt="UK Social Media Awards" />
                                <img src="/images/awards/uk-content.png" className="hero-content__award-logo" alt="UK Content Awards" />
                                <svg viewBox="0 0 28 38" fill="none" xmlns="http://www.w3.org/2000/svg" className="hero-content__wreath">
